...
const features = [
  {
    icon: Server,
    title: 'Infraestrutura centralizada',
    description: 'Gerencie aplicações, serviços, storage, rotas e backups em uma operação unificada.',
  },
  {
    icon: Activity,
    title: 'Operação em tempo real',
    description: 'Monitore ambientes, disponibilidade e eventos críticos com visibilidade operacional contínua.',
  },
  {
    icon: Lock,
    title: 'Governança e segurança',
    description: 'Controle acessos, políticas e trilhas críticas com postura enterprise desde a entrada.',
  },
]
...
const LoginHero = () => {
  ...
  return (
    <section className="order-2 lg:order-1">
      <Card className="zeus-surface-grid relative overflow-hidden p-7 sm:p-10 lg:p-12">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_22%_18%,rgba(79,144,255,0.22),transparent_24%),radial-gradient(circle_at_82%_14%,rgba(47,192,255,0.12),transparent_18%),radial-gradient(circle_at_62%_82%,rgba(37,99,235,0.12),transparent_26%)]" />
        <div className="relative">
          ...
          <div className="mt-10 max-w-[640px] space-y-6">
            <p className="zeus-eyebrow">AI Cloud OS</p>
            <h1 className="zeus-heading-title max-w-[680px]">Controle sua infraestrutura em uma única plataforma</h1>
